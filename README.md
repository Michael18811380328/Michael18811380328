...
📍 Beijing, China | Frontend Developer | Algorithm Enthusiast | Open Source Learner

🌐 Personal Website: michael18811380328.github.io

What I'm doing

🚀 I'm a front end software engineer (mainly JS) interested in leetcode algorithms, react, testing and automation.

[I'm currently learning some new things - mostly focusing on algorithms and React etc](https://michael18811380328.github.io/site/personal/site/index.html).
...
|---|---|---|---|
|[**ai\-app\-examples**](https://github.com/Michael18811380328/ai-app-examples)|micooz/ai\-app\-examples|A collection of AI application development cases, covering practical AI landing projects for learning and secondary development\.|AI Application Development|
|[**zh\-hans\.reactjs\.org**](https://github.com/Michael18811380328/zh-hans.reactjs.org)|reactjs/zh\-hans\.react\.dev|Mirror of the official React Chinese documentation for offline reading and knowledge sorting\.|React System Learning|
|[**genshin\_artifact**](https://github.com/Michael18811380328/genshin_artifact)|wormtql/genshin\_artifact|Genshin Impact artifact analysis tool, supporting automatic matching, scoring and potential evaluation\.|Tool Development|
|[**PixivBiu**](https://github.com/Michael18811380328/PixivBiu)|txperl/PixivBiu|A practical Pixiv auxiliary tool with image downloading and content filtering functions\.|Crawler \&amp; Tool Development|
|[**react**](https://github.com/Michael18811380328/react)|yisainan/react|High\-quality React project collection for learning industrial\-level architecture and best practices\.|React Advanced Practice|
|[**pinyin\-match**](https://github.com/Michael18811380328/pinyin-match)|xmflswood/pinyin\-match|High\-performance pinyin matching library, supporting word segmentation, abbreviation and polyphonic character matching for search scenarios\.|Frontend Tool Library|
